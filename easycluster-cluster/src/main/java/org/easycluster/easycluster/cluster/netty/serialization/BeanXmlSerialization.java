...
public class BeanXmlSerialization implements Serialization {

	private static final Logger	LOGGER			= LoggerFactory.getLogger(BeanXmlSerialization.class);
	...
	public <T> byte[] serialize(T object) {
		...
		String text = XmlUtil.marshal(object);
	...
	public <T> T deserialize(byte[] bytes, Class<T> type) {
		...
		T object = XmlUtil.unmarshal(text, type);
